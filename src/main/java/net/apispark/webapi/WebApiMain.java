...
public class WebApiMain {
    ...
    private static void preloadData() {
        ContactPersistence.INSTANCE.addContact(new Contact("41ee2e80-75bf-11e5-b476-cbcba715b961", "John", "Smith", Gender.Male, "svg-1"));
        ContactPersistence.INSTANCE.addContact(new Contact("41ee5590-75bf-11e5-b476-cbcba715b961", "Brenda", "Jones", Gender.Female, "svg-6"));
    }
}
